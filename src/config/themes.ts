export const themes = {
    ...
    corporate: {
        ...
        colors: {
            ...
            accent: '96 165 250',
            textMain: '255 255 255',
            textSecondary: '205 215 230',
            textMuted: '148 163 184',
            textSubtle: '100 115 145',
            accentDark: '25 70 195',
        },
    ...
    nature: {
        ...
        colors: {
            ...
            accent: '74 222 128',
            textMain: '255 255 255',
            textSecondary: '210 240 220',
            textMuted: '187 247 208',
            textSubtle: '120 185 155',
            accentDark: '15 120 55',
        },
    ...
    urgent: {
        ...
        colors: {
            ...
            accent: '239 68 68',
            textMain: '255 255 255',
            textSecondary: '210 210 218',
            textMuted: '161 161 170',
            textSubtle: '110 110 125',
            accentDark: '180 22 22',
        },
    ...
    legal: {
        ...
        colors: {
            ...
            accent: '234 179 8',
            textMain: '255 255 255',
            textSecondary: '215 228 248',
            textMuted: '191 219 254',
            textSubtle: '140 168 215',
            accentDark: '158 105 2',
        },
    ...
    health: {
        ...
        colors: {
            ...
            accent: '45 212 191',
            textMain: '255 255 255',
            textSecondary: '205 215 228',
            textMuted: '156 163 175',
            textSubtle: '108 118 138',
            accentDark: '8 112 100',
        },
    ...
    luxury: {
        ...
        colors: {
            ...
            accent: '251 191 36',
            textMain: '255 255 255',
            textSecondary: '205 205 210',
            textMuted: '161 161 170',
            textSubtle: '108 108 118',
            accentDark: '175 90 3',
        },
        gradient: 'linear-gradient(135deg, rgb(0 0 0) 0%, rgb(60 60 60) 100%)'
    },
    forge_dark: {
        label: '🔥 Forja Oscura (Metal/Ámbar)',
        heroOverlay: '15 15 14',
        colors: {
            primary: '240 168 36',
            secondary: '15 15 14',
            surface: '28 28 26',
            accent: '200 133 10',
            textMain: '240 237 232',
            textSecondary: '200 196 187',
            textMuted: '122 120 112',
            textSubtle: '106 104 96',
            accentDark: '160 100 5',
        },
        gradient: 'linear-gradient(90deg, rgb(200 133 10) 0%, rgb(240 168 36) 40%, transparent 100%)'
    },
    beauty: {
        label: 'Estética (Rosa)',
        heroOverlay: '80 7 36',
        colors: {
            ...
            accent: '244 114 182',
            textMain: '255 255 255',
            textSecondary: '248 200 215',
            textMuted: '253 164 175',
            textSubtle: '195 125 160',
            accentDark: '178 22 92',
        },
    ...
    tech: {
        ...
        colors: {
            ...
            accent: '167 139 250',
            textMain: '255 255 255',
            textSecondary: '205 212 232',
            textMuted: '148 163 184',
            textSubtle: '108 118 148',
            accentDark: '88 32 198',
        },
    ...
    clean_light: {
        ...
        colors: {
            ...
            accent: '59 130 246',
            textMain: '15 23 42',
            textSecondary: '38 52 82',
            textMuted: '71 85 105',
            textSubtle: '105 122 148',
            accentDark: '22 68 195',
        },
    ...
    clay_paper: {
        ...
        colors: {
            ...
            accent: '217 119 6',
            textMain: '78 29 29',
            textSecondary: '92 42 32',
            textMuted: '120 53 15',
            textSubtle: '132 88 58',
            accentDark: '142 62 5',
        },
    ...
    forest_stone: {
        ...
        colors: {
            ...
            accent: '161 98 7',
            textMain: '30 41 59',
            textSecondary: '42 60 88',
            textMuted: '71 85 105',
            textSubtle: '98 115 135',
            accentDark: '52 92 8',
        },
    ...
    classic_workshop: {
        ...
        colors: {
            ...
            accent: '234 179 8',
            textMain: '255 255 255',
            textSecondary: '220 228 240',
            textMuted: '203 213 225',
            textSubtle: '148 165 188',
            accentDark: '140 60 5',
        },
    ...
    sky_white: {
        ...
        colors: {
            ...
            accent: '56 189 248',
            textMain: '15 23 42',
            textSecondary: '38 55 88',
            textMuted: '100 116 139',
            textSubtle: '128 145 168',
            accentDark: '22 68 195',
        },
    ...
    sand_terra: {
        ...
        colors: {
            ...
            accent: '245 158 11',
            textMain: '28 25 23',
            textSecondary: '52 48 42',
            textMuted: '87 83 78',
            textSubtle: '118 112 105',
            accentDark: '192 68 5',
        },
    ...
    mint_fresh: {
        ...
        colors: {
            ...
            accent:    '13 148 136',
            textMain:  '15 23 42',
            textSecondary: '32 48 72',
            textMuted: '71 85 105',
            textSubtle: '105 122 145',
            accentDark: '2 88 62',
        },
    ...
    slate_modern: {
        ...
        colors: {
            ...
            accent: '251 191 36',
            textMain: '15 23 42',
            textSecondary: '35 52 82',
            textMuted: '71 85 105',
            textSubtle: '105 122 148',
            accentDark: '202 88 10',
        },
    ...
    rose_clean: {
        ...
        colors: {
            ...
            accent: '251 113 133',
            textMain: '17 24 39',
            textSecondary: '38 48 68',
            textMuted: '107 114 128',
            textSubtle: '138 145 162',
            accentDark: '188 16 52',
        },
    ...
    navy_gold_light: {
        ...
        colors: {
            ...
            accent: '202 138 4',
            textMain: '15 23 42',
            textSecondary: '35 52 85',
            textMuted: '71 85 105',
            textSubtle: '105 122 150',
            accentDark: '18 52 178',
        },
